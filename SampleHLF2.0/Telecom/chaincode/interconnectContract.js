...
class InterconnectContract extends Contract {
  ...
  async instantiate(ctx) {
    let cdrId = '100000sadsvdwdfv';
    let newCDRObject = {};
    newCDRObject.docType = "CDR"
    newCDRObject.cdrId = cdrId;
    newCDRObject.operatorId = 'operatorA';
    newCDRObject.callingNumber = 123456;
    newCDRObject.calledNumber = 456789;
    newCDRObject.startDate = '02/25/2020';
    newCDRObject.startTime = '22:01:02';
    newCDRObject.callDuration = 3;
    newCDRObject.callType = 'IN';
    newCDRObject.switchUsed = 'B';

    let dataBuffer = Buffer.from(JSON.stringify(newCDRObject));
    await ctx.stub.putState(cdrId, dataBuffer);
    console.info('telnet Smart Contract Instantiated. cdrID is ', newCDRObject );
  }
